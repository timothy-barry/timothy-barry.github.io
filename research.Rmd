...
2. [**ondisc**](https://timothy-barry.github.io/ondisc/): A computational engine for large-scale analyses of single-cell data; designed to run on all platforms, from laptops to supercomputers.