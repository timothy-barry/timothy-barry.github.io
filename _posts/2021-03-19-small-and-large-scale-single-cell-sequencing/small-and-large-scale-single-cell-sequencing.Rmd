---
title: "Small- and large-scale single-cell sequencing"
description: |
  An overview of standard (i.e., small-scale) and large-scale single-cell sequencing.
author:
  - name: Tim Barry
...
We present a brief ovewview/review of single-cell sequencing.
